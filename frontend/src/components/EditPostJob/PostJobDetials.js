                ...
                <form>
                    ...
                    <div className="col-md-12">
                        <div className={notValidClasses.cityCls}>
                            <PlacesAutocomplete value={this.state.city} defaultValue={this.state.city} onChange={this.cityChangeHandle} disabled>
                                {({ getInputProps, getSuggestionItemProps, suggestions, loading }) => (
                                    <div className="autocomplete-root">
                                        <label for="city">Location</label>
                                        <input {...getInputProps({ className: 'form-control', name: "city", type: "text", autoComplete: "noop", disabled: "true" })} />
